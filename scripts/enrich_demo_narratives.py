...
YIDA_CARDS: dict[int, dict] = {
    ...
    3: {
        ...
        "body": (
            ...
            "据 curated 建筑词库（尚未映射 SLC buri，通道标 landmark）：\n"
        ...
        "scene": {
            ...
            "visual_note": "抬头看爱奥尼柱廊；通道标 landmark，非馆藏 URI。",
        },
    },
    4: {
        "title": "外滩18与「麦加利银行大楼」",
        "body": (
            ...
            "据 curated 词库：原英国渣打银行上海分行，1923年落成，"
    ...
    6: {
        ...
        "body": (
            ...
            "据 curated 词库：怡和洋行作为早期贸易洋行代表，"
            "是外滩开埠叙事里不可跳过的一站。"
            "你带走的应是可核的开埠界面与诚实通道标注——"
            "有 SLC buri 的可点 URI，无 buri 的标 landmark，不伪装馆藏。\n\n"
